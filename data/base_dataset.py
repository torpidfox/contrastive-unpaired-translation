...
def get_transform(opt, params=None, scale=False,  noise=False, grayscale=False, method=Image.BICUBIC, convert=True):
    transform_list = []
    if grayscale:
    ...
    if scale:
        transform_list.append(transforms.RandomAffine(0, scale=(0.7, 1.5)))
